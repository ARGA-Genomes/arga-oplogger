...
pub enum UpdateCommand {
    ...
    Extractions,
    /// Update library preparations with the reduced logs
    Libraries,
    /// Update sequence runs with the reduced logs
    SequenceRuns,
    /// Update assemblies with the reduced logs
    Assemblies,
    /// Update data products with the reduced logs
    DataProducts,
    /// Update annotations with the reduced logs
    Annotations,
    /// Update depositions with the reduced logs
    Depositions,
    /// Update projects with the reduced logs
    Projects,
}
...
fn main() -> Result<(), Error> {
    ...
    match &cli.command {
        ...
        Commands::Update(cmd) => match cmd {
            ...
            UpdateCommand::SequenceRuns => sequence_runs::update()?,
            ...
            UpdateCommand::Projects => projects::update()?,
        },
